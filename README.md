...
# method 1 - install each container and manually set up database connection
...
# create admin @ strong password
# storage & database option - select mysql/mariadb
# database user - root
# database password - root (as set during mariadb docker install)
